            ...
            <div className="flex 2xl:flex-row flex-col justify-center items-center bg-white p-3 lg:p-5 w-full lg:w-4/5">
                            ...
                            <label >
                                <div className='flex flex-col items-center justify-center h-full mt-14'>
                                    <div className='flex flex-col items-center justify-center'>
                                        ...
                                        <p className='text-lg text-center'>Click to Upload image</p>
                                    </div>
                ...
                <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
                    <input
                        ...
                        className="outline-none text-2xl sm:text-3xl font-bold border-b-2 focus:border-red-500 border-gray-200 p-2"
                    />
                    {user && (
                    ...
                    <input
                        ...
                        className="outline-none focus:border-red-500 text-base sm:text-lg border-b-2 border-gray-200 p-2"
                    />
                    <input
                        type="url"
                        value={destination}
                        ...
                        className="outline-none text-base sm:text-lg border-b-2 focus:border-red-500 border-gray-200 p-2"
                    />
